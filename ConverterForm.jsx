...
const ConverterForm = () => {
    ...
    // Function para e fetch ang exchange rate tapos ihatag dayon ang result
  ...
  return (
       <form className="converter-form" onSubmit={handleFormsSubmit}>
